    ...
    <div class="questionPage">
        ...
        <el-dialog :visible.sync="dialogTableVisible" :title="dialogTitle" :before-close="beforeClose">
            <el-form :model="dialogForm" ref="dialogForm" :rules="dialogRules">
                <el-row :gutter="10">
                    <!-- <el-col :span="10">
                        <el-form-item label="题目Id" prop="questionId">
                            <el-input v-model="dialogForm.questionId"></el-input>
                        </el-form-item>
                    </el-col> -->
                    <el-col :span="20">
                ...
                <el-row :gutter="10">
                    <el-col :span="10">
                        <el-form-item label="题目种类" prop="type">
                ...
                <el-row :gutter="10">
                    <el-col :span="10">
                        <el-form-item label="题目难度" prop="level">
                            <el-input v-model="dialogForm.level"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="10">
                        <el-form-item label="题目通过率" prop="rate">
                            <el-input v-model="dialogForm.rate"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
        ...
        <el-card class="box-card">
            ...
            <div class="search">
                <el-form :inline="true" class="demo-form-inline" size="small">
                    <el-form-item>
                        <el-input v-model="searchContent" placeholder="题目名称/种类" suffix-icon="el-icon-search"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table :data="tableData" style="width: 100%" height="450">
                ...
                <el-table-column prop="type" label="题目种类" ></el-table-column>
                <el-table-column prop="description" label="题目描述" ></el-table-column>
                <el-table-column prop="level" label="题目难易程度" ></el-table-column>
                <el-table-column prop="rate" label="题目通过率" ></el-table-column>
...
import {getQuestions,addQues,alterQues,deleteQues,searchQues} from '@/api/questions'
    export default {
        data() {
            return {
                pageBean: {
        ...
        methods: {
                ...
                this.$refs['dialogForm'].validate((val)=>{
                    if(val){
                        if(this.dialogTitle === '新增'){
                            //调用新增的接口
                            addQues(this.dialogForm).then(res =>{
                                console.log('新增请求');
                                console.log(res);
            ...
            searchBtn:throttle(function(){
                if(this.searchContent.trim() != ''){
                    //调用查询接口
                    searchQues(this.searchContent,this.pageBean).then(res => {
            ...
            handleDelete(index,row){
                this.$confirm('是否要删除该信息','警告',{
                    ...
                    console.log('删除接口');
                    //调用删除接口
                    deleteQues(row.questionId).then(res => {
