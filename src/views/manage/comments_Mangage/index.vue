        ...
        <el-card class="box-card">
            ...
            <div class="search">
                <el-form :inline="true" class="demo-form-inline" size="small">
                    <el-form-item>
                        <el-input v-model="searchContent" placeholder="评论的题目" suffix-icon="el-icon-search"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-pagination style="text-align:center" :current-page="pageBean.currentPage" :pageSize="pageBean.pageSize" :total="pageBean.totalData"
